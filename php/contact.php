...
<body> 
<div style="background: linear-gradient(rgba(26,26,26,0.2),rgba(26,26,26,0.7)), url('../images/background6.jpg');
...
<img src="../images/feedback.png" width="0px"><i class="fa fa-comments"></i>&nbsp;&nbsp;Feedback<br><br><br>
<form method="POST">
